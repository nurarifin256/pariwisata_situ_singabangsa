    ...
    <div class='login-page'>
        <div class="form-boxx">
            ...
            <div class='button-boxx'>
                <div id='btn-reg'></div>
                <button type='button' class='toggle-btn'>Daftar Toko</button>
            </div>

            <form id='login' class='input-group-loginn' method="POST" action="<?= base_url() ?>Auth/registrasiToko">

                <input type='text' class='input-field' placeholder='Masukan Nama Toko' name="nama" value="<?= set_value('nama') ?>" autocomplete="off" autofocus>
