...
<div class="container mt-5">
    <h3 class="text-center">Detail Pesanan Cemilan</h3>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="6" class="text-right">
                            <a href="<?= base_url() ?>Toko2/Pesanan" class="btn btn-success mr-2 mt-1"><i class="fas fa-long-arrow-alt-left mr-2"></i>Kembali</a>
                        </td>
                    </tr>
